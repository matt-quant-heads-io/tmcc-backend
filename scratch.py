...
def should_local_calculate(question, financials, debug=False):
    ...
    Examples:
    user query: "Does AMCR have an improving gross margin profile as of FY2023? If gross margin is not a useful metric for a company like this, then state that and explain why.", data: ['grossProfit', 'grossProfitRatio', 'revenue', 'costOfRevenue'], answer: "True"
...
def do_local_calculate(question, financials, debug=False):
    try:
        ...
        Examples:
        user query: "Compare MSFT's cloud sales growth over the past 2 years. How do they define risk as it relates to their cloud business?", data: ['revenue', 'Fiscal Date', 'report_date'], answer: "financials['sales_growth'] = financials['revenue'].pct_change(periods=-1).round(2).dropna()"
        user query: "Compare IBM's cloud sales growth over the past 2 years. How do they define risk as it relates to their cloud business?", data: ['revenue', 'Fiscal Date', 'report_date'], answer: "financials['sales_growth'] = financials['revenue'].pct_change(periods=-1).round(2).dropna()"
        ...
        user query: "Does AMCR have an improving gross margin profile as of FY2023? If gross margin is not a useful metric for a company like this, then state that and explain why.", data: ['grossProfit', 'grossProfitRatio', 'revenue', 'costOfRevenue'], answer: "financials['gross_margin'] = (financials['revenue'] - financials['costOfRevenue']) / financials['revenue']"
...
def get_relevant_rows(financials, question, debug=False):
    ...
    Examples:
       ...
       "query": "What's MSFT's cloud sales growth over the past 2 years? How do they differentiate their definitions of risk as it relates to their respective cloud businesses?", "avalailable rows": ['revenue', 'costOfRevenue', 'grossProfit', 'grossProfitRatio', 'researchAndDevelopmentExpenses', 'generalAndAdministrativeExpenses', 'sellingAndMarketingExpenses', 'sellingGeneralAndAdministrativeExpenses', 'otherExpenses', 'operatingExpenses', 'costAndExpenses', 'interestIncome', 'interestExpense', 'depreciationAndAmortization', 'ebitda', 'ebitdaratio', 'operatingIncome', 'operatingIncomeRatio', 'totalOtherIncomeExpensesNet', 'incomeBeforeTax', 'incomeBeforeTaxRatio', 'incomeTaxExpense', 'netIncome', 'netIncomeRatio', 'eps', 'epsdiluted', 'weightedAverageShsOut', 'weightedAverageShsOutDil', 'link', 'finalLink', 'cashAndCashEquivalents', 'shortTermInvestments', 'cashAndShortTermInvestments', 'netReceivables', 'inventory', 'otherCurrentAssets', 'totalCurrentAssets', 'propertyPlantEquipmentNet', 'goodwill', 'intangibleAssets', 'goodwillAndIntangibleAssets', 'longTermInvestments', 'taxAssets', 'otherNonCurrentAssets', 'totalNonCurrentAssets', 'otherAssets', 'totalAssets', 'accountPayables', 'shortTermDebt', 'taxPayables', 'deferredRevenue', 'otherCurrentLiabilities', 'totalCurrentLiabilities', 'longTermDebt', 'deferredRevenueNonCurrent', 'deferredTaxLiabilitiesNonCurrent', 'otherNonCurrentLiabilities', 'totalNonCurrentLiabilities', 'otherLiabilities', 'capitalLeaseObligations', 'totalLiabilities', 'preferredStock', 'commonStock', 'retainedEarnings', 'accumulatedOtherComprehensiveIncomeLoss', 'othertotalStockholdersEquity', 'totalStockholdersEquity', 'totalEquity', 'totalLiabilitiesAndStockholdersEquity', 'minorityInterest', 'totalLiabilitiesAndTotalEquity', 'totalInvestments', 'totalDebt', 'netDebt', 'deferredIncomeTax', 'stockBasedCompensation', 'changeInWorkingCapital', 'accountsReceivables', 'accountsPayables', 'otherWorkingCapital', 'otherNonCashItems', 'netCashProvidedByOperatingActivities', 'investmentsInPropertyPlantAndEquipment', 'acquisitionsNet', 'purchasesOfInvestments', 'salesMaturitiesOfInvestments', 'otherInvestingActivites', 'netCashUsedForInvestingActivites', 'debtRepayment', 'commonStockIssued', 'commonStockRepurchased', 'dividendsPaid', 'otherFinancingActivites', 'netCashUsedProvidedByFinancingActivities', 'effectOfForexChangesOnCash', 'netChangeInCash', 'cashAtEndOfPeriod', 'cashAtBeginningOfPeriod', 'operatingCashFlow', 'capitalExpenditure', 'freeCashFlow'], "correctly selected rows": ['revenue']
    """
...
def get_relevant_fiscal_columns(financials, question, debug=False):
    ...
    dates are required to answer the question. When the question indicates that it will be necessary downstream to calculate a percentage change (e.g. for calculating revenue growth)
    ...
    query: "Does ADBE have an improving operating margin profile as of FY2022?", answer: ['Q4 2022', 'Q3 2022', 'Q2 2022', 'Q1 2022', 'Q4 2021', 'Q3 2021', 'Q2 2021', 'Q1 2021']
    query: "What is the operating margin profile for ADBE as of FY2022?", answer: ['Q4 2022', 'Q3 2022', 'Q2 2022', 'Q1 2022']
    ...
    query: "Show how amzn's cogs have grown quarterly for the past 4 quarters?", answer: ['Q2 2024', 'Q1 2024', 'Q4 2023', 'Q3 2023', 'Q2 2023', 'Q1 2023'] 
...
def get_relevant_calendar_columns(financials, question, debug=False):
    ...
    Examples:   
        query: "what's amzn's revenue growth for 2022? tie it to product recent product announcements", available columns: ['2024-06-30','2024-03-31','2023-12-31','2023-09-30','2023-06-30','2023-03-31','2022-12-31','2022-09-30','2022-06-30','2022-03-31','2021-12-31','2021-09-30','2021-06-30','2021-03-31','2020-12-31','2020-09-30','2020-06-30','2020-03-31','2019-12-31','2019-09-30','2019-06-30','2019-03-31','2018-12-31','2018-09-30','2018-06-30','2018-03-31','2017-09-30','2017-06-30','2017-03-31','2016-12-31','2016-09-30','2016-06-30','2016-03-31','2015-12-31','2015-09-30','2015-06-30','2015-03-31','2014-12-31','2014-09-30','2014-06-30','2014-03-31','2013-12-31','2013-09-30','2013-06-30','2013-03-31','2012-12-31','2012-09-30','2012-06-30','2012-03-31','2011-12-31','2011-09-30','2011-06-30','2011-03-31','2010-12-31','2010-09-30','2010-06-30','2010-03-31','2009-12-31','2009-09-30','2009-06-30','2009-03-30'], answer: ['2022-12-31', '2022-09-30', '2022-06-30', '2022-03-31', '2021-12-31'] 
...
def perform_quantitative_vector_search(question, results, debug=False):
    try:    
        ...
        if len(qual_and_quant_df) > 0:
            ...
            citations_for_backend = [{"report_date": f'{t["report_date"].split("T")[0]}', "text": t["text"], "id": "", "logo": t["logo"], "page_number": t["page_number"], "url": t["filing_url"], "title": f'{t["company_name"]} {t["filing_type"]} {t["report_date"].split("T")[0]}' , "company": t["company_name"], "importance": 1.0} for t in response["data"]["Get"]["Dow30_10K_10Q"]]
...
#             # citations = [{"text": t["text"], "id": "", "logo": t["logo"], "page_number": t["page_number"], "url": t["filing_url"], "title": f'{t["company_name"]} {t["filing_type"]} {t["report_date"].split("T")[0]}' , "company": t["company_name"], "importance": 1.0 - float(t["_additional"]["distance"])} for t in results["data"]["Get"]["Dow30_10K_10Q"]]
#             citations = [{"text": t["text"], "id": "", "logo": t["logo"], "page_number": t["page_number"], "url": t["filing_url"], "title": f'{t["company_name"]} {t["filing_type"]} {t["report_date"].split("T")[0]}' , "company": t["company_name"], "importance": 1.0} for t in response["data"]["Get"]["Dow30_10K_10Q"]]
#             citations_for_backend = [{"report_date": f'{t["report_date"].split("T")[0]}', "text": t["text"], "id": "", "logo": t["logo"], "page_number": t["page_number"], "url": t["filing_url"], "title": f'{t["company_name"]} {t["filing_type"]} {t["report_date"].split("T")[0]}' , "company": t["company_name"], "importance": 1.0} for t in response["data"]["Get"]["Dow30_10K_10Q"]]
#             citations = sorted(citations, key=lambda d: d['importance'], reverse=True)
...
#         citations_for_backend = [{"report_date": f'{t["report_date"].split("T")[0]}', "text": t["text"], "id": "", "logo": t["logo"], "page_number": t["page_number"], "url": t["filing_url"], "title": f'{t["company_name"]} {t["filing_type"]} {t["report_date"].split("T")[0]}' , "company": t["company_name"], "importance": 1.0 - float(t["_additional"]["distance"])} for t in response["data"]["Get"]["Dow30_10K_10Q"]]
